...
var PRODUCTS = [
  ...
  },
  {
    ...
    detail: ["ð Server: Asia", "ð° AR: 45", "â­ Karakter 5â: Mona,Diluc,Navia,Flins", "âï¸ Weapon 5â: A thousand floating dreams, Skyward", "ð¤ Username: Unset", "ð Birthdate (BD): Set (30/12)", "ð Note Akun:", "-Pity limit 10 off", "-Pity Wp 13 off"],
  }
];
