/* =========================================================
   Kyusei - Product Data (FIXED)
   - FIX utama:
     1) koma hilang (contoh: code: "A001", ) ✅
     2) trailing comma di item terakhir ✅
     3) karakter aneh di komentar ✅ (dihapus)
   ========================================================= */
...
var PRODUCTS = [
  ...
  },
  {
    ...
    detail: ["Ketua guild", "Anjayani", "Ope", "Terkuat"]
  },
  {
    code: "B003",
    name: "Muani",
    ...
    sold: false,
    photos: [
      "https://kyusei-edit-bot.maunyolongyaaaa.workers.dev/i/assets%2Fproducts%2FB003%2F1.jpg?w=900&q=75",
      "https://kyusei-edit-bot.maunyolongyaaaa.workers.dev/i/assets%2Fproducts%2FB003%2F2.jpg?w=900&q=75"
    ],
