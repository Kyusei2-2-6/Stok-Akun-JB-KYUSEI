...
var PRODUCTS = [
  ...
  },
  {
    ...
    "detail": [
      ...
      "ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ° AR: 45 (Hold)",
      "ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ­ÃÂÃÂÃÂÃÂ Karakter 5ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ: Navia,Flins,Mona,Diluc",
      "ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¯ÃÂÃÂÃÂÃÂ¸ÃÂÃÂÃÂÃÂ Weapon 5ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ: A thousand floating dreams, Skyward Spine",
      "ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¤ Username: Unset",
      "ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Birthdate (BD): Set (30/12)",
      "ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Note: Baru Ce Gmail fresh"
    ]
  },
  {
    "code": "A003",
  ...
  },
  {
    ...
    "detail": [
      "Ã°ÂÂÂ Server: Asia",
      "Ã°ÂÂÂ° AR: 6",
      "Ã¢Â­Â Karakter 5Ã¢ÂÂ: Colombina,Qiqi",
